...
func (x *Request) Reset() {
	*x = Request{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rpcdemo_proto_msgTypes[0]
...
func (*Request) Descriptor() ([]byte, []int) {
	return file_rpcdemo_proto_rawDescGZIP(), []int{0}
}
...
func (x *Response) Reset() {
	*x = Response{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rpcdemo_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Response) Descriptor() ([]byte, []int) {
	return file_rpcdemo_proto_rawDescGZIP(), []int{1}
}
...
var file_rpcdemo_proto_rawDesc = []byte{
	0x0a, 0x0d, 0x72, 0x70, 0x63, 0x64, 0x65, 0x6d, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12,
	0x07, 0x72, 0x70, 0x63, 0x64, 0x65, 0x6d, 0x6f, 0x22, 0x1d, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75,
...
var (
	file_rpcdemo_proto_rawDescOnce sync.Once
	file_rpcdemo_proto_rawDescData = file_rpcdemo_proto_rawDesc
)

func file_rpcdemo_proto_rawDescGZIP() []byte {
	file_rpcdemo_proto_rawDescOnce.Do(func() {
		file_rpcdemo_proto_rawDescData = protoimpl.X.CompressGZIP(file_rpcdemo_proto_rawDescData)
	})
...
func init() { file_rpcdemo_proto_init() }
func file_rpcdemo_proto_init() {
	if File_rpcdemo_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_rpcdemo_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_rpcdemo_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_rpcdemo_proto_goTypes,
		DependencyIndexes: file_rpcdemo_proto_depIdxs,
		MessageInfos:      file_rpcdemo_proto_msgTypes,
	}.Build()
	File_rpcdemo_proto = out.File
	file_rpcdemo_proto_rawDesc = nil
	file_rpcdemo_proto_goTypes = nil
	file_rpcdemo_proto_depIdxs = nil
}
