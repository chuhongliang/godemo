<template>
  <div class="app-container">
    <el-form ref="form" :model="form" label-width="120px">
      ...
      <el-form-item label="减少时间(%)">
        <el-input-number v-model="form.decr_time" />
      </el-form-item>
      <el-form-item label="增加产量(%)">
        <el-input-number v-model="form.add_result" />
      </el-form-item>
      <el-form-item label="升级消耗">
        <el-input-number v-model="form.consume" />
      </el-form-item>
...
<script>
import { createItem } from '@/api/land'
  ...
  methods: {
    onSubmit() {
      ...
      const data = {
        ...
        decr_time: this.form.decr_time,
        add_result: this.form.add_result,
